...
from ecoledoctorale.views import *

app_name = 'ecoledoctorale'

urlpatterns = [
    path('civilite/<int:ecole>/', civilite, name='civilite'),
    ...
    path('step_4/', validation_step_ecole, name='diplome_step_4'),
